          ...
          {isLoading ? (
            ...
            >
              <div className="flex flex-col items-center space-y-3">
                <div className="w-8 h-8 rounded-full border-2 border-srm-crimson dark:border-srm-gold border-t-transparent animate-spin" />
                <p className="text-xs font-semibold tracking-wider">Syncing SRM Database...</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <button
                ...
                className="mt-5 text-[10px] font-black uppercase tracking-wider text-srm-crimson dark:text-srm-gold border border-srm-crimson/20 dark:border-srm-gold/20 hover:border-srm-crimson dark:hover:border-srm-gold bg-srm-crimson/5 dark:bg-srm-gold/5 px-4 py-2 rounded-xl transition-all cursor-pointer"
              >
                Reset Filters
              </button>
            </motion.div>
