...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#07090e] text-slate-800 dark:text-slate-100 flex flex-col justify-center items-center px-6 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute top-1/4 left-1/4 w-[400px] h-[400px] bg-srm-blue/10 dark:bg-srm-blue/[0.03] rounded-full blur-[100px] pointer-events-none -z-10" />
      <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] bg-srm-crimson/10 dark:bg-srm-crimson/[0.03] rounded-full blur-[100px] pointer-events-none -z-10" />
      ...
      >
        ...
        {/* SRM Branding Icon Header */}
        <div className="text-center mb-8">
          <div className="w-12 h-12 rounded-2xl srm-gradient flex items-center justify-center font-bold text-white text-base shadow-lg shadow-srm-crimson/15 mx-auto mb-4">
            SR
          </div>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-xs mt-1.5 leading-relaxed font-semibold">
            AI-powered Academic Synergy Platform for SRM Institute
          </p>
        </div>

        {/* Access Restriction Warning Banner */}
        <div className="bg-srm-crimson/5 dark:bg-amber-950/10 border border-srm-crimson/15 dark:border-amber-900/35 rounded-xl p-3.5 flex items-start space-x-2.5 mb-6 text-left">
          <AlertCircle className="w-4.5 h-4.5 text-srm-crimson dark:text-srm-gold shrink-0 mt-0.5" />
          <div className="space-y-0.5">
            <h4 className="text-[10px] font-black text-srm-crimson dark:text-srm-gold uppercase tracking-widest">Strict Security Protocol</h4>
            <p className="text-[10px] text-slate-500 dark:text-slate-405 leading-relaxed font-medium">
              Authorized access is restricted to **SRM Faculty** and **PhD Scholars**. Emails without **@srmist.edu.in** are automatically rejected.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-1.5 text-[9px] font-black text-slate-450 dark:text-slate-500 uppercase tracking-widest">
              <Sparkles className="w-3.5 h-3.5 text-srm-gold" />
            ...
            >
              <span>Login as SRM Faculty PI</span>
            ...
            >
              <span>Login as SRM Faculty PI</span>
              <span className="text-[9px] text-slate-450 dark:text-emerald-500 font-sans uppercase font-black">Dr. Priya (Biotech)</span>
            </button>
          </div>
