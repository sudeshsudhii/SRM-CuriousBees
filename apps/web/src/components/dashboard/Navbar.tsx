...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* ─── MAIN NAVBAR ─────────────────────────────────────────────── */}
      <header className="sticky top-0 z-30 h-16 w-full bg-surface/90 backdrop-blur-md border-b border-outline-variant/25 flex items-center justify-between px-4 md:px-margin-desktop gap-3 font-sans">
